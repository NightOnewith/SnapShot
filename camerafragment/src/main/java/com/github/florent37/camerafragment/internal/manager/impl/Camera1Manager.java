...
public class Camera1Manager extends BaseCameraManager<Integer, SurfaceHolder.Callback> implements Camera.PreviewCallback{
                            ...
                            public void run() {
                                cameraOpenListener.onCameraOpened(cameraId, previewSize, new SurfaceHolder.Callback() {
                                    ...
                                    public void surfaceCreated(SurfaceHolder surfaceHolder) {
                                        ...
                                        Log.e("surface", "surfaceCreated()--> 111");
                                    ...
                                    public void surfaceChanged(SurfaceHolder surfaceHolder, int format, int width, int height) {
                                        ...
                                        Log.e("surface", "surfaceChanged()--> 222");
                                        startPreview(surfaceHolder);
                                    }

                                    @Override
                                    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
                                        Log.e("surface", "surfaceDestroyed()--> 333");
                                    }
                                });
                            }
                        });
...
//                parameters.setRecordingHint(true);
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        Log.e("onPreviewFrame", "----> " + String.valueOf(data.length));
    }
