package com.cyzn.yzj.snapshot.util.network;
...
public final class NetWorkUtil {
    ...
    public interface ConnectTips {
        String NO_NETWORK = "当前没有网络";
        String WIFI = "当前为WIFI网络";
        String MOBILE = "当前使用手机流量";
        String MOBILE_2G = "当前使用2G网络";
        String MOBILE_3G = "当前使用3G网络";
        String MOBILE_4G = "当前使用4G网络";
        String MOBILE_UNKNOWN = "当前手机网络未知";
        String OTHER = "其他网络";
        String NO_CONNECTED = "网络没有连接";
    }
}